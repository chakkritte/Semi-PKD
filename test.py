...
tracker = OfflineEmissionsTracker(country_iso_code="AUS", save_to_file=False)
...
# Emissions as CO2-equivalents [kg CO2eq]
emissions = round(float(tracker.stop()*1000),4)
# Sum of cpu_energy, gpu_energy and ram_energy [W]
power = round(float(tracker.final_emissions_data.energy_consumed)*1000, 4)

print("Emission = gCO2",emissions)
print("Power = W",power)
