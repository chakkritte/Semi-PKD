...
from PKD.core.trainer import train_labeled
...
args.save = '{}/{}-{}-teacher-{}'.format(args.output_dir, args.dataset, args.student, time.strftime("%Y%m%d-%H%M%S"))
...
for epoch in range(0, args.no_epochs):
    ...
    with torch.no_grad():
        if args.ema_kd:
            _ = validate(ema_model, optimizer, val_loader, epoch, device, None, lr)
